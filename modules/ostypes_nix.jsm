...
nixInit.prototype = {
  ...
  CONST: {
    ...
    // ADV CONSTANTS
    // Helper events.
    IN_CLOSE: this.CONST.IN_CLOSE_WRITE | this.CONST.IN_CLOSE_NOWRITE,
    IN_MOVE: this.CONST.IN_MOVED_FROM | this.CONST.IN_MOVED_TO,
    
    // All events which a program can wait on.
    IN_ALL_EVENTS: (this.CONST.IN_ACCESS | this.CONST.IN_MODIFY | this.CONST.IN_ATTRIB | this.CONST.IN_CLOSE_WRITE | this.CONST.IN_CLOSE_NOWRITE | this.CONST.IN_OPEN | this.CONST.IN_MOVED_FROM | this.CONST.IN_MOVED_TO | this.CONST.IN_CREATE | this.CONST.IN_DELETE | this.CONST.IN_DELETE_SELF | this.CONST.IN_MOVE_SELF)
    // end - INOTIFY
  },
  HELPER: {
    // here
